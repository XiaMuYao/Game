 ...
 * 金币赞助
 */
public class GoldRecordFragment extends BaseFragment implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        switch (view.getId()) {
            case R.id.iv_right_gold:
                startActivity(new Intent(mActivity, GoldSearchActivity.class));
                break;
        }
    }
}
